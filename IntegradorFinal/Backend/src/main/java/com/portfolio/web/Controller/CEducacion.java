...
//@CrossOrigin(origins = "https://apdantefront.web.app")
public class CEducacion {
    ...
    public ResponseEntity<?> create(@RequestBody dtoEducacion dtoeducacion){
        ...
        return new ResponseEntity(new Mensaje("La educacion fue creada exitosamente"), HttpStatus.OK);
    ...
    public ResponseEntity<?>update(@PathVariable("id")int id, @RequestBody dtoEducacion dtoeducacion){
        ...
        if(StringUtils.isBlank(dtoeducacion.getNombreE())){
            return new ResponseEntity(new Mensaje("Campo vacio"), HttpStatus.BAD_REQUEST);
        }
